      ...
      <div className="solution_cards_box">
        <div className="solution_card">
          ...
          <div className="solu_title">
            <h3 className="text-white">{ele.title}</h3>
          </div>
          <div className="solu_description">
            <p>{ele.desc.slice(0, 85) + "..."}</p>
            <span className="position-absolute" style={{ bottom: "12px" }}>
              <a href={ele.link} target="_blank" type="button" className="btn btn-primary">
                View More
              </a>
            </span>
          </div>
